...
<form method="post" action="/login"><input type="hidden" name="csrf" value="{{.CSRF}}"><input type="hidden" name="transaction" value="{{.Transaction}}">
...
<form method="post" action="/account/password"><input type="hidden" name="csrf" value="{{.CSRF}}"><input type="hidden" name="transaction" value="{{.Transaction}}">
...
<section><h2>Create user</h2><form method="post" action="/admin/users/create"><input type="hidden" name="csrf" value="{{.CSRF}}">
